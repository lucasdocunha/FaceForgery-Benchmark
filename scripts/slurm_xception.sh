...
echo "Iniciando treinamento: xception (regime: $REGIME, workers: $WORKERS)"
...
echo "=========================================================="
echo "Treinamento xception finalizado em: $(date)"
echo "=========================================================="
