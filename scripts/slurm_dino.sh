...
echo "Iniciando treinamento: dino (regime: $REGIME, workers: $WORKERS)"
...
echo "=========================================================="
echo "Treinamento dino finalizado em: $(date)"
echo "=========================================================="
